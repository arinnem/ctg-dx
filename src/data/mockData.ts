...
export const initiativesData = [
  {
    ...
    qa: [
      {
        question: "Sáng kiến này giải quyết vấn đề cốt lõi nào?",
        answer: "Sáng kiến 'Giải ngân online' giải quyết vấn đề về thời gian xử lý hồ sơ tín dụng kéo dài và quy trình thủ công phức tạp, dẫn đến trải nghiệm không tốt cho khách hàng doanh nghiệp."
      },
      {
        question: "Kết quả 'Giảm 70% thời gian xử lý hồ sơ' được tính toán như thế nào?",
        answer: "Chúng tôi đã đo lường thời gian trung bình từ lúc khách hàng nộp hồ sơ đến khi nhận được giải ngân trước và sau khi triển khai hệ thống. Trước đây, quy trình mất trung bình 10 ngày làm việc. Hiện tại, với hệ thống mới, thời gian trung bình chỉ còn 3 ngày. Mức giảm 7 ngày tương đương với 70%."
      },
      {
        question: "Hệ thống mới có đảm bảo an toàn và bảo mật không?",
        answer: "Tuyệt đối. Hệ thống được xây dựng trên nền tảng công nghệ bảo mật nhiều lớp, bao gồm mã hóa đầu cuối, xác thực đa yếu tố (MFA) và tuân thủ các tiêu chuẩn bảo mật quốc tế như ISO 27001."
      },
      {
        question: "Khách hàng doanh nghiệp cần chuẩn bị những gì để sử dụng nền tảng này?",
        answer: "Khách hàng chỉ cần có tài khoản doanh nghiệp tại VietinBank và chuẩn bị các hồ sơ pháp lý, tài chính dưới dạng file mềm (scan hoặc file PDF) để tải lên hệ thống theo hướng dẫn."
      },
      {
        question: "Lộ trình phát triển tiếp theo của sáng kiến là gì?",
        answer: "Trong giai đoạn tiếp theo, chúng tôi sẽ tích hợp trí tuệ nhân tạo (AI) để tự động hóa một phần quá trình thẩm định sơ bộ và mở rộng nền tảng cho các sản phẩm vay vốn phức tạp hơn."
      }
    ]
  },
  {
    ...
    highlightResults: [
      {
        title: 'Người dùng mới tăng 10% sau 3 tháng.',
        description: "Số lượng người dùng mới được tính là tổng số khách hàng đăng ký và kích hoạt thành công ứng dụng iPay/eFast. Chúng tôi đã so sánh tổng số người dùng mới trong 3 tháng sau khi ra mắt phiên bản mới với tổng số của 3 tháng liền kề trước đó. Kết quả cho thấy sự tăng trưởng 10%."
      },
      {
        title: 'Số lượng giao dịch tăng 10% sau 3 tháng.',
        description: "Chỉ số này đo lường tổng số lượng giao dịch tài chính (chuyển khoản, thanh toán hóa đơn, nạp tiền) được thực hiện qua ứng dụng. Dữ liệu được so sánh giữa quý sau và quý trước khi ra mắt phiên bản mới."
      },
      {
        title: 'Top 3 ứng dụng tài chính trên App Store.',
        description: "Thứ hạng được ghi nhận trên bảng xếp hạng 'Ứng dụng Tài chính Miễn phí' của Apple App Store tại thị trường Việt Nam. Thứ hạng này được duy trì ổn định trong vòng 2 tháng sau khi ra mắt."
      }
    ],
    qa: [
      {
        question: "Tại sao cần phải xây dựng lại ứng dụng iPay & eFast?",
        answer: "Phiên bản cũ của iPay & eFast có giao diện đã lỗi thời và thiếu các tính năng cạnh tranh như eKYC hay soft OTP. Việc xây dựng lại nhằm mục đích cải thiện trải nghiệm người dùng, nâng cao bảo mật và bắt kịp xu hướng thị trường."
      },
      {
        question: "Làm thế nào để đo lường 'Người dùng mới tăng 10%'?",
        answer: "Chúng tôi so sánh số lượng người dùng đăng ký và kích hoạt thành công tài khoản trong 3 tháng sau khi ra mắt phiên bản mới so với 3 tháng ngay trước đó. Dữ liệu được thu thập từ hệ thống phân tích người dùng của chúng tôi."
      },
      {
        question: "Hệ sinh thái đối tác bao gồm những gì?",
        answer: "Hệ sinh thái đối tác cho phép người dùng thanh toán trực tiếp các hóa đơn điện, nước, internet, mua vé xem phim, đặt phòng khách sạn và nhiều dịch vụ khác ngay trên ứng dụng mà không cần chuyển qua nền tảng khác."
      },
      {
        question: "Tính năng eKYC (định danh khách hàng điện tử) hoạt động như thế nào?",
        answer: "eKYC cho phép khách hàng mở tài khoản trực tuyến 100% bằng cách chụp ảnh giấy tờ tùy thân (CMND/CCCD) và xác thực khuôn mặt qua camera điện thoại. Công nghệ AI sẽ tự động kiểm tra và đối chiếu thông tin."
      },
      {
        question: "Soft OTP có an toàn hơn SMS OTP truyền thống không?",
        answer: "Có. Soft OTP được tích hợp ngay trong ứng dụng và mã OTP được tạo ra theo thời gian thực, không phụ thuộc vào sóng di động và giảm thiểu rủi ro bị kẻ gian chiếm đoạt SIM để đọc trộm mã OTP."
      }
    ]
  },
  {
    ...
    highlightResults: [
      {
        title: 'Tiết kiệm 500 giờ làm việc mỗi tháng.',
        description: "Số giờ tiết kiệm được tính bằng cách nhân (thời gian xử lý thủ công - thời gian xử lý bằng robot) với số lần thực hiện quy trình mỗi tháng. Ví dụ, việc đối soát giao dịch cuối ngày trước đây tốn 2 giờ/ngày bởi 2 nhân viên, nay robot chỉ mất 10 phút giám sát, tiết kiệm gần 4 giờ/ngày cho quy trình đó."
      },
      {
        title: 'Số lượng hồ sơ tăng 20%.',
        description: "Với thời gian được giải phóng khỏi các công việc thủ công, các cán bộ có thêm thời gian để tư vấn và xử lý các hồ sơ phức tạp hơn, dẫn đến năng suất tổng thể của phòng ban tăng 20%."
      },
      {
        title: 'Có thể xử lý từ xa.',
        description: "Việc áp dụng BPM và RPA cho phép các quy trình được chuẩn hóa và thực hiện trên nền tảng số. Nhờ đó, nhân viên có thể khởi tạo, theo dõi và phê duyệt các tác vụ từ xa mà không cần phải có mặt tại văn phòng, đảm bảo hoạt động kinh doanh liên tục."
      }
    ],
    qa: [
      {
        question: "RPA (Robotic Process Automation) được áp dụng vào những quy trình cụ thể nào?",
        answer: "Chúng tôi đã áp dụng RPA vào các quy trình lặp đi lặp lại và có quy tắc rõ ràng như: nhập liệu báo cáo, đối soát giao dịch cuối ngày, và gửi thông báo tự động cho khách hàng."
      },
      {
        question: "Con số 'Tiết kiệm 500 giờ làm việc mỗi tháng' được tính như thế nào?",
        answer: "Con số này được tính bằng cách lấy tổng thời gian nhân viên phải bỏ ra để thực hiện các công việc thủ công trước đây, trừ đi thời gian giám sát robot sau khi tự động hóa. Ví dụ, một quy trình mất 30 phút thủ công, robot chỉ cần 2 phút, tiết kiệm 28 phút cho mỗi lần thực hiện."
      },
      {
        question: "Việc tự động hóa có làm giảm số lượng nhân sự không?",
        answer: "Mục tiêu của dự án không phải là cắt giảm nhân sự. Thay vào đó, chúng tôi giải phóng nhân viên khỏi các công việc nhàm chán, lặp đi lặp lại để họ có thể tập trung vào các nhiệm vụ có giá trị cao hơn như phân tích, tư vấn và chăm sóc khách hàng."
      },
      {
        question: "Nhân viên có cần kỹ năng lập trình để sử dụng RPA không?",
        answer: "Không. Đội ngũ dự án sẽ xây dựng và cấu hình các robot. Nhân viên chỉ cần khởi chạy các robot này thông qua một giao diện đơn giản hoặc robot sẽ tự động chạy theo lịch trình đã được cài đặt sẵn."
      },
      {
        question: "Lợi ích lớn nhất mà BPM và RPA mang lại là gì?",
        answer: "Lợi ích lớn nhất là việc tiêu chuẩn hóa và tối ưu hóa quy trình. Điều này không chỉ giúp tăng năng suất, giảm sai sót mà còn tạo ra một nền tảng vững chắc để ngân hàng có thể mở rộng quy mô hoạt động một cách hiệu quả."
      }
    ]
  },
  {
    ...
    highlightResults: [
      {
        title: 'Giảm 60% thời gian chờ đợi của khách hàng.',
        description: "Thời gian chờ đợi được tính từ lúc khách hàng đặt câu hỏi cho đến khi nhận được phản hồi đầu tiên từ nhân viên hỗ trợ. Với chatbot, khách hàng nhận được câu trả lời ngay lập tức, giảm đáng kể so với việc phải chờ kết nối với nhân viên."
      },
      {
        title: 'Tỷ lệ hài lòng đạt 92%.',
        description: "Sau mỗi cuộc hội thoại, chatbot sẽ đưa ra một khảo sát nhanh yêu cầu người dùng đánh giá mức độ hài lòng trên thang điểm 5. Tỷ lệ 92% là tổng số lượt đánh giá 4 và 5 sao trên tổng số lượt đánh giá nhận được."
      },
      {
        title: 'Xử lý 10,000+ câu hỏi mỗi ngày.',
        description: "Đây là tổng số lượng câu hỏi mà chatbot đã tiếp nhận và xử lý thành công trong một ngày cao điểm. Con số này cho thấy khả năng mở rộng và đáp ứng nhu cầu lớn của hệ thống."
      }
    ],
    qa: [
      {
        question: "AI Chatbot có thể xử lý những loại câu hỏi nào?",
        answer: "Chatbot có thể xử lý một loạt các câu hỏi phổ biến như: thông tin về sản phẩm (lãi suất, phí dịch vụ), hướng dẫn sử dụng iPay, tra cứu địa điểm ATM/chi nhánh, và các câu hỏi chung về chính sách của ngân hàng."
      },
      {
        question: "Tỷ lệ hài lòng 92% được đo lường ra sao?",
        answer: "Sau mỗi cuộc hội thoại, chatbot sẽ đưa ra một khảo sát nhanh yêu cầu người dùng đánh giá mức độ hài lòng trên thang điểm 5. Tỷ lệ 92% là tổng số lượt đánh giá 4 và 5 sao trên tổng số lượt đánh giá nhận được."
      },
      {
        question: "Điều gì xảy ra nếu chatbot không hiểu câu hỏi của khách hàng?",
        answer: "Nếu chatbot không thể trả lời câu hỏi sau 2 lần thử, nó sẽ tự động đưa ra tùy chọn để kết nối trực tiếp với nhân viên hỗ trợ. Cuộc trò chuyện và lịch sử sẽ được chuyển liền mạch để nhân viên có thể nắm bắt bối cảnh."
      },
      {
        question: "Chatbot có được đào tạo và cập nhật liên tục không?",
        answer: "Có. Đội ngũ của chúng tôi liên tục phân tích các cuộc hội thoại (đã được ẩn danh) để xác định các điểm yếu và bổ sung kiến thức mới cho chatbot hàng tuần, giúp nó ngày càng thông minh hơn."
      },
      {
        question: "Công nghệ xử lý ngôn ngữ tự nhiên (NLP) nào đang được sử dụng?",
        answer: "Chúng tôi đang sử dụng một mô hình NLP tùy chỉnh được xây dựng dựa trên kiến trúc Transformer, kết hợp với các dịch vụ của Google Dialogflow để có khả năng hiểu ngữ cảnh và ý định của người dùng một cách tốt nhất."
      }
    ]
  },
  {
    ...
    highlightResults: [
      {
        title: 'Tạo báo cáo tự động 100%.',
        description: "Tất cả các báo cáo hoạt động định kỳ trước đây được thực hiện thủ công nay đã được tự động hóa hoàn toàn. Hệ thống tự động trích xuất, xử lý và trình bày dữ liệu mà không cần sự can thiệp của con người."
      },
      {
        title: 'Tiết kiệm 300 giờ làm việc mỗi tháng.',
        description: "Đây là tổng thời gian mà các chuyên viên phân tích tiết kiệm được từ việc không phải tổng hợp dữ liệu thủ công. Thời gian này được chuyển sang các hoạt động phân tích chuyên sâu và đưa ra các đề xuất kinh doanh."
      },
      {
        title: 'Độ chính xác dữ liệu đạt 99.9%.',
        description: "Độ chính xác được đảm bảo bằng cách kết nối trực tiếp với các hệ thống nguồn (core banking, CRM) thông qua API, loại bỏ hoàn toàn bước nhập liệu thủ công. Con số 99.9% được xác định thông qua các quy trình đối soát và kiểm toán dữ liệu tự động."
      }
    ],
    qa: [
      {
        question: "Hệ thống này tự động hóa những loại báo cáo nào?",
        answer: "Hệ thống có thể tự động hóa hầu hết các báo cáo hoạt động hàng ngày, hàng tuần và hàng tháng, chẳng hạn như báo cáo kinh doanh, báo cáo rủi ro, và báo cáo hiệu suất hoạt động của các chi nhánh."
      },
      {
        question: "Làm thế nào để đảm bảo 'Độ chính xác dữ liệu đạt 99.9%'?",
        answer: "Độ chính xác được đảm bảo bằng cách kết nối trực tiếp với các hệ thống nguồn (core banking, CRM) thông qua API, loại bỏ hoàn toàn bước nhập liệu thủ công. Con số 99.9% được xác định thông qua các quy trình đối soát và kiểm toán dữ liệu tự động."
      },
      {
        question: "Ban lãnh đạo tương tác với dashboard này như thế nào?",
        answer: "Ban lãnh đạo có thể truy cập dashboard thông qua trình duyệt web trên máy tính hoặc máy tính bảng. Dashboard có giao diện tương tác, cho phép lọc, sắp xếp và xem chi tiết dữ liệu (drill-down) chỉ với vài cú nhấp chuột."
      },
      {
        question: "Dữ liệu trên dashboard có phải là dữ liệu thời gian thực không?",
        answer: "Dữ liệu được cập nhật gần như thời gian thực. Hầu hết các chỉ số được làm mới sau mỗi 15 phút, đảm bảo ban lãnh đạo luôn có thông tin mới nhất để ra quyết định."
      },
      {
        question: "Việc xây dựng hệ thống này có phức tạp không?",
        answer: "Việc xây dựng đòi hỏi chuyên môn về kỹ thuật dữ liệu và phân tích kinh doanh. Thách thức lớn nhất là việc làm sạch và hợp nhất dữ liệu từ nhiều hệ thống nguồn khác nhau để tạo ra một nguồn dữ liệu duy nhất và đáng tin cậy (Single Source of Truth)."
      }
    ]
  },
  {
    ...
    highlightResults: [
      {
        title: 'Đào tạo 5,000+ nhân viên mỗi năm.',
        description: "Đây là tổng số lượt nhân viên hoàn thành ít nhất một khóa học trên nền tảng trong một năm. Con số này cho thấy sự tham gia tích cực và quy mô của chương trình đào tạo."
      },
      {
        title: 'Tỷ lệ hoàn thành khóa học đạt 85%.',
        description: "Tỷ lệ này được tính bằng số học viên hoàn thành 100% nội dung khóa học chia cho tổng số học viên đã đăng ký. Tỷ lệ cao cho thấy nội dung hấp dẫn và nền tảng dễ sử dụng."
      },
      {
        title: 'Tiết kiệm 40% chi phí đào tạo.',
        description: "Chi phí tiết kiệm được tính bằng cách so sánh tổng chi phí tổ chức các lớp học truyền thống (thuê địa điểm, in ấn tài liệu, chi phí đi lại) với chi phí vận hành và phát triển nội dung cho nền tảng e-learning. Việc chuyển đổi sang hình thức trực tuyến đã cắt giảm đáng kể các chi phí logistics."
      }
    ],
    qa: [
      {
        question: "Nền tảng này cung cấp những loại khóa học nào?",
        answer: "Nền tảng cung cấp đa dạng các khóa học, từ các kỹ năng nghiệp vụ (sản phẩm, quy trình) đến các kỹ năng mềm (giao tiếp, quản lý thời gian) và kiến thức về chuyển đổi số, an toàn thông tin."
      },
      {
        question: "Chỉ số 'Tiết kiệm 40% chi phí đào tạo' được tính như thế nào?",
        answer: "Chi phí tiết kiệm được tính bằng cách so sánh tổng chi phí tổ chức các lớp học truyền thống (thuê địa điểm, in ấn tài liệu, chi phí đi lại) với chi phí vận hành và phát triển nội dung cho nền tảng e-learning. Việc chuyển đổi sang hình thức trực tuyến đã cắt giảm đáng kể các chi phí logistics."
      },
      {
        question: "Làm thế nào để theo dõi và đánh giá tiến độ học tập của nhân viên?",
        answer: "Hệ thống có một dashboard dành riêng cho quản lý, cho phép theo dõi tỷ lệ tham gia, tiến độ hoàn thành và kết quả các bài kiểm tra của từng nhân viên hoặc từng phòng ban. Hệ thống cũng tự động gửi báo cáo và nhắc nhở."
      },
      {
        question: "Các khóa học có tính tương tác không?",
        answer: "Có. Chúng tôi thiết kế các khóa học với nhiều yếu tố tương tác như video, câu đố (quiz), bài tập tình huống và diễn đàn thảo luận để học viên không cảm thấy nhàm chán và có thể áp dụng kiến thức ngay."
      },
      {
        question: "Nhân viên có thể học trên thiết bị di động không?",
        answer: "Chắc chắn rồi. Nền tảng được thiết kế theo phương pháp 'mobile-first', đảm bảo trải nghiệm học tập mượt mà và đầy đủ tính năng trên cả điện thoại thông minh và máy tính bảng."
      }
    ]
  },
];
...
export const missionsData = [
  ...
  },
  {
    ...
    highlightResults: [
      {
        title: 'Nâng cấp 100% hệ thống bảo mật.',
        description: "Tất cả các hệ thống bảo mật đã được nâng cấp lên phiên bản mới nhất với các tính năng bảo mật tiên tiến, bao gồm mã hóa đầu cuối, xác thực đa yếu tố, và giám sát bảo mật 24/7."
      },
      {
        title: 'Tuân thủ 100% tiêu chuẩn quốc tế.',
        description: "Hệ thống đã được chứng nhận tuân thủ các tiêu chuẩn bảo mật quốc tế như ISO 27001, PCI DSS, và các quy định của Ngân hàng Nhà nước Việt Nam."
      },
      {
        title: 'Giảm 95% các mối đe dọa bảo mật.',
        description: "Sau khi triển khai hệ thống bảo mật mới, số lượng các mối đe dọa bảo mật đã giảm đáng kể, đảm bảo an toàn cho toàn bộ hệ thống thông tin của ngân hàng."
      }
    ],
    qa: [
      {
        question: "Hệ thống bảo mật mới có những tính năng gì?",
        answer: "Hệ thống bảo mật mới bao gồm mã hóa đầu cuối, xác thực đa yếu tố (MFA), giám sát bảo mật 24/7, phát hiện xâm nhập thông minh, và các công cụ phân tích bảo mật tiên tiến."
      },
      {
        question: "Làm thế nào để đảm bảo tuân thủ các tiêu chuẩn quốc tế?",
        answer: "Chúng tôi đã thực hiện đánh giá toàn diện và triển khai các biện pháp bảo mật theo đúng yêu cầu của các tiêu chuẩn ISO 27001, PCI DSS, và các quy định của Ngân hàng Nhà nước."
      },
      {
        question: "Nhân viên có cần đào tạo về hệ thống bảo mật mới không?",
        answer: "Có, tất cả nhân viên đã được đào tạo về các quy trình bảo mật mới, cách sử dụng xác thực đa yếu tố, và các biện pháp bảo mật cơ bản để đảm bảo an toàn thông tin."
      }
    ]
  },
  {
    ...
    highlightResults: [
      {
        title: 'Giảm 70% thời gian phê duyệt.',
        description: "Thời gian phê duyệt trung bình đã giảm từ 5 ngày xuống còn 1.5 ngày nhờ việc tự động hóa các bước đánh giá và tích hợp AI trong quy trình ra quyết định."
      },
      {
        title: 'Tăng 30% độ chính xác đánh giá rủi ro.',
        description: "Hệ thống AI đã cải thiện độ chính xác trong việc đánh giá rủi ro tín dụng bằng cách phân tích đa chiều các yếu tố và dữ liệu lịch sử."
      },
      {
        title: 'Xử lý 500+ hồ sơ mỗi ngày.',
        description: "Hệ thống có khả năng xử lý hơn 500 hồ sơ tín dụng mỗi ngày, tăng đáng kể so với năng lực xử lý thủ công trước đây."
      }
    ],
    qa: [
      {
        question: "Hệ thống AI đánh giá rủi ro như thế nào?",
        answer: "Hệ thống AI phân tích đa chiều các yếu tố như lịch sử tín dụng, thu nhập, tài sản, và các chỉ số tài chính khác để đưa ra đánh giá rủi ro toàn diện và chính xác."
      },
      {
        question: "Làm thế nào để đảm bảo tính minh bạch trong quyết định AI?",
        answer: "Hệ thống cung cấp báo cáo chi tiết về các yếu tố ảnh hưởng đến quyết định, cho phép nhân viên hiểu rõ lý do đằng sau mỗi quyết định phê duyệt hoặc từ chối."
      },
      {
        question: "Có cần sự can thiệp của con người trong quy trình không?",
        answer: "Hệ thống tự động xử lý 80% các hồ sơ đơn giản, trong khi 20% hồ sơ phức tạp sẽ được chuyển cho nhân viên có kinh nghiệm để đánh giá thêm."
      },
      {
        question: "Hệ thống có thể xử lý các loại tín dụng nào?",
        answer: "Hiện tại hệ thống xử lý tín dụng tiêu dùng và tín dụng doanh nghiệp vừa và nhỏ. Chúng tôi đang mở rộng để xử lý các loại tín dụng phức tạp hơn."
      }
    ]
  },
  {
