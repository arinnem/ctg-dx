...
import ViewAllButton from './components/ViewAllButton'; // Import ViewAllButton
...
const recognitionPosts = [
  {
    ...
    postcardTitle: 'Phòng Truyền thông',
  ...
  },
  {
    ...
    postcardTitle: 'Khối Công nghệ Thông tin',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold text-gray-900 mb-4">
              Chào mừng bạn đến với <span className="text-blue-600">PROJECT X01</span>
            </h1>
            <p className="text-xl text-gray-600">
              Nơi cung cấp thông tin về Hành trình Chuyển đổi của VietinBank
            </p>
          </div>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {featuredInitiatives.map((initiative) => (
                <div key={initiative.id} className="bg-white rounded-xl shadow-lg overflow-hidden">
                  <img className="w-full h-48 object-cover" src={initiative.imageUrl} alt={initiative.title} />
                  <div className="p-4">
